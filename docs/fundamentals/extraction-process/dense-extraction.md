...
| `parallel_workers` | `4` | When > 1, Phase 1 skeleton batches and Phase 2 fill batches run in parallel to reduce wall-clock time. Set `1` for sequential extraction. |
