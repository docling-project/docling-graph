...
2. **[Examples](../09-examples/quickstart.md)** - See complete working examples
3. **[Pipeline Configuration](../04-pipeline-configuration/index.md)** - Configure extraction after creating templates
...
- **[Example Templates](../09-examples/index.md)** - Production-ready templates
- **[API Reference](../11-reference/config.md)** - PipelineConfig and model details
