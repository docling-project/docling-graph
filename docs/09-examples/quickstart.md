...
- **[Invoice Extraction →](invoice-extraction.md)** - Full invoice with relationships
- **[Research Paper →](research-paper.md)** - Complex scientific documents
- **[ID Card →](id-card.md)** - Vision-based extraction

### Documentation

- **[Schema Definition →](../03-schema-definition/index.md)** - Template creation guide
- **[CLI Reference →](../07-cli/index.md)** - All CLI commands
- **[Python API →](../08-api/index.md)** - Programmatic usage

### Advanced Topics

- **[Custom Backends →](../10-advanced/custom-backends.md)** - Create custom extractors
- **[Performance Tuning →](../10-advanced/performance-tuning.md)** - Optimize processing
- **[Testing →](../10-advanced/testing.md)** - Test your templates
...
**Next:** Try the [Invoice Extraction](invoice-extraction.md) example for a more complete workflow!
