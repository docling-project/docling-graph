...
2. **[Graph Analysis →](../06-graph-management/graph-analysis.md)** - Analyze extracted data
3. **[Neo4j Integration →](../06-graph-management/neo4j-integration.md)** - Load into database
