...
**Prerequisites:**
- Understanding of [Schema Definition](../03-schema-definition/index.md)
...
- **[Schema Definition](../03-schema-definition/index.md)** - Template creation
- **[Python API](../08-api/index.md)** - API usage
- **[Examples](../09-examples/index.md)** - Example templates
