...
1. **[Installation](../02-installation/index.md)**: Set up your environment with `uv`
2. **[Schema Definition](../03-schema-definition/index.md)**: Create Pydantic templates defining what to extract
3. **[Pipeline Configuration](../04-pipeline-configuration/index.md)**: Configure extraction backend and processing mode
4. **[Extraction Process](../05-extraction-process/index.md)**: Run document conversion and data extraction
5. **[Graph Management](../06-graph-management/index.md)**: Export graphs and create visualizations
...
- **[Examples](../09-examples/index.md)**: Working code examples
- **[CLI Reference](../07-cli/index.md)**: Command-line usage
- **[Python API](../08-api/index.md)**: Programmatic usage

---

**Ready to transform your documents into knowledge graphs?** Let's begin with [installation](../02-installation/index.md)!