...
1. **[Extraction Process →](../05-extraction-process/index.md)** - Learn how extraction works
2. **[Graph Management](../06-graph-management/index.md)** - Work with extracted graphs
3. **[CLI Guide](../07-cli/index.md)** - Use command-line interface
