...
**Navigation:** [← Docling Settings](docling-settings.md) | [Next: Configuration Examples →](configuration-examples.md)
...
3. **[Graph Management](../06-graph-management/index.md)** - Working with graphs
