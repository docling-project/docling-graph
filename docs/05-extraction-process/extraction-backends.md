...
flowchart LR
    ...
    C@{ shape: doc, label: "Markdown" }
    D@{ shape: tag-proc, label: "Chunking" }
    E@{ shape: procs, label: "LLM Extraction" }
    
    F@{ shape: doc, label: "Pydantic Models" }
...
flowchart LR
    ...
    B@{ shape: procs, label: "VLM Processing" }
    C@{ shape: lin-proc, label: "Visual Understanding" }
    D@{ shape: tag-proc, label: "Direct Extraction" }
    
    E@{ shape: doc, label: "Pydantic Models" }
