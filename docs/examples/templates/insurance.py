...
class Guarantee(BaseModel):
    ...
    coverage_conditions: Optional[List[str]] = Field(
        ...
        examples=[
            [
                "Effraction extérieure des bâtiments",
                "Escalade des bâtiments",
    ...
    exclusions: Optional[List[str]] = Field(
        ...
        examples=[
            [
                "Dommages corporels subis par les personnes assurées",
                "Frais de réparation des biens à l'origine du sinistre",
            ],
