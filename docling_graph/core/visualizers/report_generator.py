...
class ReportGenerator:
    ...
    def _create_dense_stats(dense_stats: dict) -> str:
        ...
        labels = {
            ...
            "coverage_pass_recovered": "Coverage-pass nodes recovered",
            "coverage_pass_capped": "Coverage-pass nodes capped (over-growth)",
            "skeleton_path_counts": "Skeleton instances per path",
