"""Dense contract strategy-level operations."""
...
def extract_dense_from_text(
    *,
    ...
    """Run dense extraction for raw text by chunking first."""
...
def extract_dense_from_document(
    *,
    backend: Any,
    doc_processor: Any,
    document: Any,
    ...
    """Run dense extraction for converted document using chunk metadata."""
