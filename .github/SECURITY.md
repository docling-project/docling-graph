...
We will send announcements of security vulnerabilities and steps to remediate on the [Docling announcements](https://github.com/ibm/docling-graph/discussions/categories/announcements).